...
package.loaded["blinkcmp_source_copilot"] = (function()
    ...
    function M:get_completions(ctx, callback)
        ...
        if ok and req_id then
            return function() client:cancel_request(req_id) end
        end
        return function() end
    end
...
vim.keymap.set({ "o", "x" }, "ac", function() require("nvim-treesitter-textobjects.select").select_textobject("@class.outer", "textobjects") end)
vim.keymap.set({ "o", "x" }, "ic", function() require("nvim-treesitter-textobjects.select").select_textobject("@class.inner", "textobjects") end)
vim.keymap.set({ "o", "x" }, "af", function() require("nvim-treesitter-textobjects.select").select_textobject("@function.outer", "textobjects") end)
vim.keymap.set({ "o", "x" }, "if", function() require("nvim-treesitter-textobjects.select").select_textobject("@function.inner", "textobjects") end)
...
vim.api.nvim_create_autocmd({ "FileType" }, {
    callback = function(_) vim.cmd.wincmd("L") end,
...
hydra({
    ...
    name = "FZF",
    heads = {
        -- { "g", function() require("fzf-lua").live_grep() end, { desc = "live_grep", exit = true } },
        { "b", function() require("fzf-lua").buffers() end, { desc = "buffers", exit = true } },
        { "C", function() require("fzf-lua").command_history() end, { desc = "command_history", exit = true } },
        { "c", function() require("fzf-lua").commands() end, { desc = "commands", exit = true } },
        { "f", function() require("fzf-lua").files() end, { desc = "files", exit = true } },
        { "g", function() require("fzf-lua").live_grep_native() end, { desc = "live_grep_native", exit = true } },
        { "h", function() require("fzf-lua").helptags() end, { desc = "helptags", exit = true } },
        { "k", function() require("fzf-lua").keymaps() end, { desc = "keymaps", exit = true } },
        { "r", function() require("fzf-lua").registers() end, { desc = "registers", exit = true } },
        { "s", function() require("fzf-lua").search_history() end, { desc = "search_history", exit = true } },
    },
})
...
hydra({
    ...
    name = "MISC",
    heads = {
        { "a", function() require("aerial").toggle() end, { desc = "aerial", exit = true } },
        { "d", vim.diagnostic.setloclist, { desc = "diag.setlocallist", exit = true } },
        { "f", function() require("conform").format({ timeout_ms = 5000, async = true }) end, { desc = "conform", exit = true } },
        { "k", function() require("memo").open() end, { desc = "memo", exit = true } },
        { "u", function() require("undotree").open() end, { desc = "undotree.open", exit = true } },
        { "U", function() vim.pack.update() end, { desc = "vim.pack.update", exit = true } },
    },
})
...
hydra({
    ...
    name = "FZF LSP",
    heads = {
        { "a", function() require("fzf-lua").lsp_code_actions({ silent = true }) end, { desc = "code_actions", exit = true } },
        { "D", function() require("fzf-lua").lsp_declarations() end, { desc = "decs", exit = true } },
        { "d", function() require("fzf-lua").lsp_definitions() end, { desc = "defs", exit = true } },
        { "i", function() require("fzf-lua").lsp_implementations() end, { desc = "impls", exit = true } },
        { "n", function() require("fzf-lua").diagnostics_document() end, { desc = "diags_document", exit = true } },
        { "N", function() require("fzf-lua").diagnostics_workspace() end, { desc = "diags_workspace", exit = true } },
        { "r", function() require("fzf-lua").lsp_references() end, { desc = "refs", exit = true } },
        { "R", function() vim.lsp.buf.rename() end, { desc = "rename", exit = true } },
    },
})
